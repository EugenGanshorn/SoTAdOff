...
final class Version20180629195338 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE device ADD COLUMN sts_hsbcolor VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE device ADD COLUMN sts_ct INTEGER DEFAULT NULL');
        $this->addSql('ALTER TABLE device ADD COLUMN sts_scheme INTEGER DEFAULT NULL');
        $this->addSql('ALTER TABLE device ADD COLUMN sts_fade INTEGER DEFAULT NULL');
        $this->addSql('ALTER TABLE device ADD COLUMN sts_speed INTEGER DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO device (id, name, ip_address, username, password, position, module, friendly_name, topic, button_topic, power, power_on_state, led_state, save_data, save_state, button_retain, power_retain, prm_baudrate, prm_group_topic, prm_ota_url, prm_restart_reason, prm_sleep, prm_boot_count, prm_save_count, prm_save_address, fwr_version, fwr_build_date_time, fwr_boot, log_serial_log, log_web_log, log_sys_log, log_log_host, log_log_port, log_tele_period, net_hostname, net_ip_address, net_gateway, net_subnetmask, net_dns_server, net_mac, net_webserver, net_wifi_config, mqtt_host, mqtt_port, mqtt_client_mask, mqtt_client, mqtt_user, mqtt_type, sts_time, sts_uptime, sts_vcc, sts_power, wifi_ap, wifi_ssid, wifi_rssi, wifi_ap_mac) SELECT id, name, ip_address, username, password, position, module, friendly_name, topic, button_topic, power, power_on_state, led_state, save_data, save_state, button_retain, power_retain, prm_baudrate, prm_group_topic, prm_ota_url, prm_restart_reason, prm_sleep, prm_boot_count, prm_save_count, prm_save_address, fwr_version, fwr_build_date_time, fwr_boot, log_serial_log, log_web_log, log_sys_log, log_log_host, log_log_port, log_tele_period, net_hostname, net_ip_address, net_gateway, net_subnetmask, net_dns_server, net_mac, net_webserver, net_wifi_config, mqtt_host, mqtt_port, mqtt_client_mask, mqtt_client, mqtt_user, mqtt_type, sts_time, sts_uptime, sts_vcc, sts_power, wifi_ap, wifi_ssid, wifi_rssi, wifi_ap_mac FROM __temp__device');
